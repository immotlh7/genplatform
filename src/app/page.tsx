...
export default function HomePage() {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      setStats({
        skills: { total: 24, active: 18, executions: 1247 },
      ...
      if (typeof window !== 'undefined' && !localStorage.getItem('dashboard-welcome-shown')) {
        addNotification({
          title: 'Welcome to GenPlatform.ai',
          message: 'Your AI agent management dashboard is ready. Explore skills, memory, and system monitoring.',
          type: 'info',
          source: 'Dashboard',
          actions: [
            { label: 'Take Tour', action: () => console.log('Start tour') },
